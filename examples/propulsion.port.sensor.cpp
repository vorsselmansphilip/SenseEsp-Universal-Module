...
const uint read_delay = 500;
  ...
  auto* pINA219 = new INA219(0x45, cal16_400);
  ...
  auto* pINA219busVoltage = new INA219value(pINA219, bus_voltage, read_delay, "/sensors/sender/busvoltage");
      ...
      pINA219busVoltage->connectTo(new SKOutputNumber("propulsion.port.sensor.busvoltage"));
  ...
  auto* pINA219shuntVoltage = new INA219value(pINA219, shunt_voltage, read_delay, "/sensors/sender/shuntvoltage");
      ...
      pINA219shuntVoltage->connectTo(new SKOutputNumber("propulsion.port.sensor.shuntvoltage"));
  ...
  auto* pINA219current = new INA219value(pINA219, current, read_delay, "/sensors/sender/current");
      ...
      pINA219current->connectTo(new SKOutputNumber("propulsion.port.sensor.current"));   

  // Do the same for the power (watts).
  auto* pINA219power = new INA219value(pINA219, power, read_delay, "/sensors/sender/power");
      
      pINA219power->connectTo(new SKOutputNumber("propulsion.port.sensor.power"));  
  ...
  auto* pINA219loadVoltage = new INA219value(pINA219, load_voltage, read_delay, "/sensors/sender/loadvoltage");
      ...
      pINA219loadVoltage->connectTo(new SKOutputNumber("propulsion.port.sensor.loadvoltage"));     
  ...
  */
  ...
  const float offset = -273.16;
    ...
    auto* sensor_temp =
      ...
      sensor_temp->connectTo(new SKOutputNumber("propulsion.port.sensor.temperature.kelvin"))
                ->connectTo(new Linear(multiplierC,offset,""))
                ->connectTo(new SKOutputNumber("propulsion.port.sensor.temperature.celsius"));   
...
/*
  sensor_temp->connect_to(new Linear(1.0, 0.0, "/sensors/sender/temperature/linear"))
      ->connect_to(
          new SKOutputNumber("propulsion.port.sensor.temperature",
